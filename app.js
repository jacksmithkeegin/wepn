...
document.addEventListener('DOMContentLoaded', () => {
    ...
    async function loadReleasesData() {
        try {
            const response = await fetch('resources/releases/release_info.json');
            if (!response.ok) {
            ...
            releases = rawReleases.map(r => ({
                ...
                // Update to use new images_small filename pattern
                artwork_small_url: r.artwork_small_url || `resources/images_small/${r.release_code.en}_small.jpg`,
